...
public class BenhNhan implements Serializable {
    ...
    public ThongTinSangLocVaDanhGiaDD getThongTinSangLocVaDanhGiaDD() {
        return this.thongTinSangLocVaDanhGiaDD;
    }

    public void setThongTinSangLocVaDanhGiaDD(ThongTinSangLocVaDanhGiaDD thongTinSangLocVaDanhGiaDD) {
        this.thongTinSangLocVaDanhGiaDD = thongTinSangLocVaDanhGiaDD;
    }

    public BenhNhan thongTinSangLocVaDanhGiaDD(ThongTinSangLocVaDanhGiaDD thongTinSangLocVaDanhGiaDD) {
        this.setThongTinSangLocVaDanhGiaDD(thongTinSangLocVaDanhGiaDD);
        return this;
    }
