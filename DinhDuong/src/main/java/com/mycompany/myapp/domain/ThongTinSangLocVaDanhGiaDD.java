...
/**
 * A ThongTinSangLocVaDanhGiaDD.
 */
@Entity
@Table(name = "thong_tin_danh_gia")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ThongTinSangLocVaDanhGiaDD implements Serializable {
    ...
    public ThongTinSangLocVaDanhGiaDD id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ThongTinSangLocVaDanhGiaDD maBN(String maBN) {
        this.setMaBN(maBN);
        return this;
    }
    ...
    public ThongTinSangLocVaDanhGiaDD mangThai(Boolean mangThai) {
    ...
    public ThongTinSangLocVaDanhGiaDD bMI(Float bMI) {
        this.setbMI(bMI);
        return this;
    }
    ...
    public ThongTinSangLocVaDanhGiaDD danhGiaBMI(Integer danhGiaBMI) {
    ...
    public ThongTinSangLocVaDanhGiaDD phanTramCanNangTrong3Thang(Float phanTramCanNangTrong3Thang) {
    ...
    public ThongTinSangLocVaDanhGiaDD danhGiaCanNang(Integer danhGiaCanNang) {
    ...
    public ThongTinSangLocVaDanhGiaDD anUongTrongTuan(String anUongTrongTuan) {
    ...
    public ThongTinSangLocVaDanhGiaDD danhGiaAnUong(Integer danhGiaAnUong) {
    ...
    public ThongTinSangLocVaDanhGiaDD thoiGianChiDinh(ZonedDateTime thoiGianChiDinh) {
    ...
    public ThongTinSangLocVaDanhGiaDD nguyCoSDD(Boolean nguyCoSDD) {
    ...
    public ThongTinSangLocVaDanhGiaDD cheDoAn(String cheDoAn) {
    ...
    public ThongTinSangLocVaDanhGiaDD danhGiaCanThiepDD(DanhGiaCanThiepDD danhGiaCanThiepDD) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ThongTinSangLocVaDanhGiaDD)) {
            return false;
        }
        return id != null && id.equals(((ThongTinSangLocVaDanhGiaDD) o).id);
    }
