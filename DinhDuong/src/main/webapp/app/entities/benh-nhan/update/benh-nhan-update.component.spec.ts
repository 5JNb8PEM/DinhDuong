...
import { IThongTinSangLocVaDanhGiaDD } from 'app/entities/thong-tin-sang-loc-va-danh-gia-dd/thong-tin-sang-loc-va-danh-gia-dd.model';
import { ThongTinSangLocVaDanhGiaDDService } from 'app/entities/thong-tin-sang-loc-va-danh-gia-dd/service/thong-tin-sang-loc-va-danh-gia-dd.service';
...
describe('BenhNhan Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call thongTinSangLocVaDanhGiaDD query and add missing value', () => {
      const benhNhan: IBenhNhan = { id: 456 };
      const thongTinSangLocVaDanhGiaDD: IThongTinSangLocVaDanhGiaDD = { id: 96514 };
      benhNhan.thongTinSangLocVaDanhGiaDD = thongTinSangLocVaDanhGiaDD;

      const thongTinSangLocVaDanhGiaDDCollection: IThongTinSangLocVaDanhGiaDD[] = [{ id: 40144 }];
      jest
        .spyOn(thongTinSangLocVaDanhGiaDDService, 'query')
        .mockReturnValue(of(new HttpResponse({ body: thongTinSangLocVaDanhGiaDDCollection })));
      const expectedCollection: IThongTinSangLocVaDanhGiaDD[] = [thongTinSangLocVaDanhGiaDD, ...thongTinSangLocVaDanhGiaDDCollection];
      jest
        .spyOn(thongTinSangLocVaDanhGiaDDService, 'addThongTinSangLocVaDanhGiaDDToCollectionIfMissing')
        .mockReturnValue(expectedCollection);

      activatedRoute.data = of({ benhNhan });
      comp.ngOnInit();

      expect(thongTinSangLocVaDanhGiaDDService.query).toHaveBeenCalled();
      expect(thongTinSangLocVaDanhGiaDDService.addThongTinSangLocVaDanhGiaDDToCollectionIfMissing).toHaveBeenCalledWith(
        thongTinSangLocVaDanhGiaDDCollection,
        thongTinSangLocVaDanhGiaDD
      );
      expect(comp.thongTinSangLocVaDanhGiaDDSCollection).toEqual(expectedCollection);
    });
    ...
    it('Should update editForm', () => {
      ...
      benhNhan.dieuTri = dieuTri;
      const thongTinSangLocVaDanhGiaDD: IThongTinSangLocVaDanhGiaDD = { id: 51061 };
      benhNhan.thongTinSangLocVaDanhGiaDD = thongTinSangLocVaDanhGiaDD;
      ...
      expect(comp.thongTinSangLocVaDanhGiaDDSCollection).toContain(thongTinSangLocVaDanhGiaDD);
  ...
  describe('Tracking relationships identifiers', () => {
    ...
    describe('trackThongTinSangLocVaDanhGiaDDById', () => {
      it('Should return tracked ThongTinSangLocVaDanhGiaDD primary key', () => {
        const entity = { id: 123 };
        const trackResult = comp.trackThongTinSangLocVaDanhGiaDDById(0, entity);
        expect(trackResult).toEqual(entity.id);
      });
    });
