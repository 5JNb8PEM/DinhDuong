...
export class BenhNhanUpdateComponent implements OnInit {
  ...
  thongTinSangLocVaDanhGiaDDSCollection: IThongTinSangLocVaDanhGiaDD[] = [];
  ...
  trackThongTinSangLocVaDanhGiaDDById(_index: number, item: IThongTinSangLocVaDanhGiaDD): number {
    return item.id!;
  }
  ...
  protected updateForm(benhNhan: IBenhNhan): void {
    this.editForm.patchValue({
      ...
      thongTinSangLocVaDanhGiaDD: benhNhan.thongTinSangLocVaDanhGiaDD,
    ...
    this.thongTinSangLocVaDanhGiaDDSCollection = this.thongTinSangLocVaDanhGiaDDService.addThongTinSangLocVaDanhGiaDDToCollectionIfMissing(
      this.thongTinSangLocVaDanhGiaDDSCollection,
      benhNhan.thongTinSangLocVaDanhGiaDD
    );
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.thongTinSangLocVaDanhGiaDDService
      .query({ filter: 'benhnhan-is-null' })
      .pipe(map((res: HttpResponse<IThongTinSangLocVaDanhGiaDD[]>) => res.body ?? []))
      .pipe(
        map((thongTinSangLocVaDanhGiaDDS: IThongTinSangLocVaDanhGiaDD[]) =>
          this.thongTinSangLocVaDanhGiaDDService.addThongTinSangLocVaDanhGiaDDToCollectionIfMissing(
            thongTinSangLocVaDanhGiaDDS,
            this.editForm.get('thongTinSangLocVaDanhGiaDD')!.value
          )
        )
      )
      .subscribe(
        (thongTinSangLocVaDanhGiaDDS: IThongTinSangLocVaDanhGiaDD[]) =>
          (this.thongTinSangLocVaDanhGiaDDSCollection = thongTinSangLocVaDanhGiaDDS)
      );
  ...
  protected createFromForm(): IBenhNhan {
    return {
      ...
      thongTinSangLocVaDanhGiaDD: this.editForm.get(['thongTinSangLocVaDanhGiaDD'])!.value,
