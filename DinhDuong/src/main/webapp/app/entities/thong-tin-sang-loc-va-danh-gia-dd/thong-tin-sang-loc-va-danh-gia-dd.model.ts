...
export interface IThongTinSangLocVaDanhGiaDD {
  id?: number;
  maBN?: string | null;
...
export class ThongTinSangLocVaDanhGiaDD implements IThongTinSangLocVaDanhGiaDD {
  constructor(
    public id?: number,
...
export function getThongTinSangLocVaDanhGiaDDIdentifier(thongTinSangLocVaDanhGiaDD: IThongTinSangLocVaDanhGiaDD): number | undefined {
  return thongTinSangLocVaDanhGiaDD.id;
}
